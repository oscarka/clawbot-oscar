...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "If the user asks to send a message or perform an action in ANY app (飞书/Feishu/Lark, 微信/WeChat, Slack, Telegram, etc.), NEVER say you don't have that capability.",
    "Instead, use **local_vision** to open the desktop app and perform the action through the GUI. You can see the screen, click buttons, type text — treat it like a human would.",
